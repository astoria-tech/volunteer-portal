const questions = [
  ...
  {
    title:
      "Do you affirm that you agree to all the Health Guidelines outlined below as a volunteer?",
    fieldName:
      "Do you affirm that you agree to all the Health Guidelines outlined above as a volunteer?",
    description:
  ...
  {
    title:
      "Do you affirm that you will adhere to the safe handling guidelines listed below as a volunteer?",
    fieldName:
      "Do you affirm that you will adhere to the safe handling guidelines listed above as a volunteer?",
    description:
  ...
  {
    title:
      "Do you affirm that you will adhere to the delivery protocols listed below as a volunteer?",
    fieldName:
      "Do you affirm that you will adhere to the delivery protocols listed above as a volunteer?",
    description:
  ...
  {
    title:
      "Do you agree to uphold and abide by the Astoria Mutual Aid Network Community Agreements throughout your interactions as a member of our community?",
    fieldName:
      "Do you agree to uphold and abide by the Astoria Mutual Aid Network Community Agreements throughout your interactions as a member of our community?",
    description:
  ...
  {
    title:
      "Beyond support on a case-by-case basis, are you interested in joining:",
    fieldName:
      "Beyond support on a case by case basis, are you interested in joining:",
    description: null,
    fieldType: {
  ...
  {
    title:
      "Any other resources, skills, interests, certifications, or knowledge do you hold that you would be open to sharing with the neighborhood?",
    fieldName:
      "What other resources, skills, interests, certifications, or knowledge do you hold that you would be open to sharing with the neighborhood?",
    description: null,
    fieldType: {
      type: "Single line text",
      showAs: null
  ...
  {
    title:
      "We are looking to identify other community/neighborhood institutions that might need support. Please list any such organizations you have contact with.",
    fieldName:
      "We are looking to identify other community/neighborhood institutions that might need support. Please list any such organizations you have contact with.",
    description: null,
    fieldType: {
